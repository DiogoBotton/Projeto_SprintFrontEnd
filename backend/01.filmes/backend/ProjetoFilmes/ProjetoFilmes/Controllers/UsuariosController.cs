...
namespace ProjetoFilmes.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpPut("{id}")]
        public IActionResult Atualizar(int id, UsuarioViewModel usuarioAtualizado)
        {
            try
            {
                Usuario usuarioBuscado = _usuarioRepository.BuscarPorId(id);

                usuarioBuscado.AlterarEmailNome(usuarioAtualizado.Email, usuarioAtualizado.Nome);
